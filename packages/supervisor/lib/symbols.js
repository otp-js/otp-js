...
export const start_children = Symbol.for('start_children');
export const start_child = Symbol.for('start_child');
export const restart_child = Symbol.for('restart_child');
export const delete_child = Symbol.for('delete_child');
export const terminate_child = Symbol.for('terminate_child');
export const restarting = Symbol.for('restarting');
export const unrecognized_response = Symbol.for('unrecognized_response');
